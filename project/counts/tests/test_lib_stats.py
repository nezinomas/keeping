...
def _chart_calendar_expect_january_no_data():
    arr = {
        ...
        'data': [
            ...
            [0, 2, 0, 1, 'None'],
            [0, 3, 0, 1, 'None'],
            [0, 4, 0.1, 53, '1999-01-01'],
            [0, 5, 0.2, 53, '1999-01-02'],
            [0, 6, 0.3, 53, '1999-01-03'],
            [1, 0, 0.1, 1, '1999-01-04'],
            [1, 1, 0.1, 1, '1999-01-05'],
            [1, 2, 0.1, 1, '1999-01-06'],
            [1, 3, 0.1, 1, '1999-01-07'],
            [1, 4, 0.1, 1, '1999-01-08'],
            [1, 5, 0.2, 1, '1999-01-09'],
            [1, 6, 0.3, 1, '1999-01-10'],
            [2, 0, 0.1, 2, '1999-01-11'],
            [2, 1, 0.1, 2, '1999-01-12'],
            [2, 2, 0.1, 2, '1999-01-13'],
            [2, 3, 0.1, 2, '1999-01-14'],
            [2, 4, 0.1, 2, '1999-01-15'],
            [2, 5, 0.2, 2, '1999-01-16'],
            [2, 6, 0.3, 2, '1999-01-17'],
            [3, 0, 0.1, 3, '1999-01-18'],
            [3, 1, 0.1, 3, '1999-01-19'],
            [3, 2, 0.1, 3, '1999-01-20'],
            [3, 3, 0.1, 3, '1999-01-21'],
            [3, 4, 0.1, 3, '1999-01-22'],
            [3, 5, 0.2, 3, '1999-01-23'],
            [3, 6, 0.3, 3, '1999-01-24'],
            [4, 0, 0.1, 4, '1999-01-25'],
            [4, 1, 0.1, 4, '1999-01-26'],
            [4, 2, 0.1, 4, '1999-01-27'],
            [4, 3, 0.1, 4, '1999-01-28'],
            [4, 4, 0.1, 4, '1999-01-29'],
            [4, 5, 0.2, 4, '1999-01-30'],
            [4, 6, 0.3, 4, '1999-01-31'],
        ]
    }
...
def _chart_calendar_expect_january_with_data(_chart_calendar_expect_january_no_data):
    ...
    _chart_calendar_expect_january_no_data['data'][11][2] = 1
    ...
    _chart_calendar_expect_january_no_data['data'][18][2] = 2
...
def test_chart_calendar_current_day_no_data(_chart_calendar_expect_january_no_data):
    _chart_calendar_expect_january_no_data['data'][5][2] = 0.5

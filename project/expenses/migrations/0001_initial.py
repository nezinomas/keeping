...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            options={
                "ordering": [
                    django.db.models.expressions.OrderBy(
                        django.db.models.expressions.F("valid_for"),
                        descending=True,
                        nulls_first=True,
                    ),
                    "title",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        upload_to=project.expenses.helpers.models_helper.upload_attachment,
                    ),
                ),
                (
                    "account",
        ...
        migrations.AddIndex(
            model_name="expense",
            index=models.Index(
                fields=["expense_type"], name="expenses_ex_expense_3c4432_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="expense",
            index=models.Index(
                fields=["expense_name"], name="expenses_ex_expense_bfb2f7_idx"
            ),
        ),
    ]

...
@patch('project.counters.managers.CounterQuerySet.App_name', 'Counter Type')
...
@patch('project.counters.managers.CounterQuerySet.App_name', 'X')
...
def test_counter_months_quantity_sum_no_records_for_current_year():

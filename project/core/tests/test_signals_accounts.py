...
def fixture_have():
    return [
        {'id': 1, 'year': 1999, 'have': 10, 'latest_check': datetime(1999, 1, 1, 3, 2, 1)},
        {'id': 1, 'year': 2000, 'have': 15, 'latest_check': datetime(2000, 1, 4, 3, 2, 1)},
        {'id': 2, 'year': 1999, 'have': 20, 'latest_check': datetime(1999, 1, 2, 3, 2, 1)},
        {'id': 2, 'year': 2000, 'have': 25, 'latest_check': datetime(2000, 1, 6, 3, 2, 1)},
    ]
...
def test_copy_have_and_latest_from_previous_year(types):
    have = [{'id': 1, 'year': 1998, 'have': 10, 'latest_check': datetime(1998, 1, 1, 3, 2, 1)},]
    incomes = [

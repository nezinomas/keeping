...
def pensions_worth():
    ...
    PensionWorthFactory(price=2.15)
...
def lend_fixture():
    ...
    LendFactory(date=date(1999, 3, 4), price=3.1, account=a2)
...
def lend_return_fixture():
    ...
    LendReturnFactory(date=date(1999, 1, 2), price=0.5, account=a1)
    LendReturnFactory(date=date(1999, 2, 3), price=1.5, account=a1)
    LendReturnFactory(date=date(1999, 3, 4), price=1.6, account=a2)

    LendReturnFactory(date=date(1974, 1, 2), price=3.5, account=a1)
    LendReturnFactory(date=date(1974, 2, 3), price=4.5, account=a1)

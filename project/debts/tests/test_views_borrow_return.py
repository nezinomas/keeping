...
def test_borrow_return_list_200(client_logged):
    url = reverse('debts:debts_return_list', kwargs={'type': 'borrow'})
...
def test_borrow_return_list_edit_button(client_logged):
    ...
    link = reverse('debts:debts_return_update', kwargs={'pk': obj.pk, 'type': 'borrow'})
...
def test_borrow_return_list_delete_button(client_logged):
    ...
    link = reverse('debts:debts_return_delete', kwargs={'pk': obj.pk, 'type': 'borrow'})
...
def test_borrow_return_new_200(client_logged):
    url = reverse('debts:debts_return_new', kwargs={'type': 'borrow'})
    response = client_logged.get(url)
...
def test_borrow_return_save_not_render_html_list(client_logged):
    ...
    data = {'date': '1999-1-3', 'borrow': b.pk, 'price': '1.1', 'account': a.pk, 'type': 'borrow'}
...
def test_borrow_return_update_200(client_logged):
    ...
    url = reverse('debts:debts_return_update', kwargs={'pk': obj.pk, 'type': 'borrow'})
    response = client_logged.get(url)
...
def test_borrow_return_update(mck, client_logged):
    ...
    url = reverse('debts:debts_return_update', kwargs={'pk': e.pk, 'type': 'borrow'})
...
def test_borrow_return_delete_200(client_logged):
    ...
    url = reverse('debts:debts_return_delete', kwargs={'pk': f.pk, 'type': 'borrow'})
    response = client_logged.get(url)
...
def test_borrow_return_delete_load_form(client_logged):
    ...
    url = reverse('debts:debts_return_delete', kwargs={'pk': obj.pk, 'type': 'borrow'})
    response = client_logged.get(url, {}, **X_Req)
...
def test_borrow_return_delete(client_logged):
    ...
    url = reverse('debts:debts_return_delete', kwargs={'pk': p.pk, 'type': 'borrow'})

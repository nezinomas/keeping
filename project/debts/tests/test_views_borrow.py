...
def test_borrow_list_200(client_logged):
    url = reverse('debts:debts_list', kwargs={'debt_type': 'borrow'})
...
def test_borrow_list_edit_button(client_logged):
    ...
    link = reverse('debts:debts_update', kwargs={'pk': obj.pk, 'debt_type': 'borrow'})
...
def test_borrow_list_delete_button(client_logged):
    ...
    link = reverse('debts:debts_delete', kwargs={'pk': obj.pk, 'debt_type': 'borrow'})
...
def test_borrow_new_200(client_logged):
    url = reverse('debts:debts_new', kwargs={'debt_type': 'borrow'})
    response = client_logged.get(url)
...
def test_borrow_update_200(client_logged):
    ...
    url = reverse('debts:debts_update', kwargs={'pk': f.pk, 'debt_type': 'borrow'})
    response = client_logged.get(url)
...
def test_borrow_update(mck, client_logged):
    ...
    url = reverse('debts:debts_update', kwargs={'pk': e.pk, 'debt_type': 'borrow'})
...
def test_borrow_update_not_load_other_journal(client_logged, main_user, second_user):
    ...
    url = reverse('debts:debts_update', kwargs={'pk': obj.pk, 'debt_type': 'borrow'})
    response = client_logged.get(url, **X_Req)
...
def test_borrow_delete_200(client_logged):
    ...
    url = reverse('debts:debts_delete', kwargs={'pk': f.pk, 'debt_type': 'borrow'})
    response = client_logged.get(url)
...
def test_borrow_delete_load_form(client_logged):
    ...
    url = reverse('debts:debts_delete', kwargs={'pk': obj.pk, 'debt_type': 'borrow'})
    response = client_logged.get(url, {}, **X_Req)
...
def test_borrow_delete(client_logged):
    ...
    url = reverse('debts:debts_delete', kwargs={'pk': p.pk, 'debt_type': 'borrow'})

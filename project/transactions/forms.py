...
class TransactionForm(ConvertToCentsMixin, YearBetweenMixin, forms.ModelForm):
...
class SavingCloseForm(ConvertToCentsMixin, YearBetweenMixin, forms.ModelForm):
    price = forms.FloatField(min_value=0.01)
...
class SavingChangeForm(ConvertToCentsMixin, YearBetweenMixin, forms.ModelForm):
    price = forms.FloatField(min_value=0.01)
    fee = forms.FloatField(min_value=0.01, required=False)
    close = forms.BooleanField(required=False)

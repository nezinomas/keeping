...
def data():
    ...
    obj.expenses = [
        {"january": 10, "february": 10, "necessary": False, "title": "T1"},
        {"january": 20, "february": 20, "necessary": True, "title": "T2"},
        {"january": 30, "february": 30, "necessary": False, "title": "T3"},
        {"january": 40, "february": 40, "necessary": True, "title": "T4"},
    ]
